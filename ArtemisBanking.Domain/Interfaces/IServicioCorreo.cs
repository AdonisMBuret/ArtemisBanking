namespace ArtemisBanking.Domain.Interfaces
{
    ...
    public interface IServicioCorreo
    {
        ...
        Task EnviarNotificacionPrestamoAprobadoAsync(
            string correo, 
        ...
        Task EnviarNotificacionCambioTasaPrestamoAsync(
            string correo, 
            string nombreCliente, 
            decimal nuevaTasa, 
            decimal nuevaCuota);
        ...
        Task EnviarNotificacionCambioLimiteTarjetaAsync(
            string correo, 
            string nombreCliente, 
        ...
        Task EnviarNotificacionTransaccionRealizadaAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
        ...
        Task EnviarNotificacionTransaccionRecibidaAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
        ...
        Task EnviarNotificacionPagoTarjetaAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
        ...
        Task EnviarNotificacionPagoPrestamoAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
        ...
        Task EnviarNotificacionAvanceEfectivoAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
            string ultimosCuatroDigitosTarjeta, 
        ...
        Task EnviarNotificacionDepositoAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
            string ultimosCuatroDigitosCuenta, 
        ...
        Task EnviarNotificacionRetiroAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
            string ultimosCuatroDigitosCuenta, 
        ...
        Task EnviarNotificacionConsumoTarjetaAsync(
            string correo, 
            string nombreCliente, 
            decimal monto, 
            string ultimosCuatroDigitosTarjeta, 
